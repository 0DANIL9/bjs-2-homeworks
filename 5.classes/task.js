...
class Student {
  ...
  getAverageBySubject(subject) {
    ...
    let sumMarks = this.marks[subject].reduce((sumMarks, current) => sumMarks + current)
  ...
  getAverage() {
    ...
    let sumMarksAll = allSubject.reduce((sumMarks, current) => sumMarks + current)
    let arithmeticMeanAll = sumMarksAll / this.sumMarks.length;
    return arithmeticMeanAll;
  }
}
